...
const Tokenomics_3 = () => {
  return (
    <section className="bg-bg-vector bg-no-repeat bg-top w-screen flex flex-col m-auto bg-contain md:pt-44 pt-0 relative ">
      <img className="eart-bg" src="/eart.png" alt="eart" />
      <img className="eart-bg-dots" src="/eart-dots.png" alt="eart dots" />
      <Container>
        <div className="w-full md:mb-44 mb-16">
          <h2 className="title md:w-[840px] md:text-start text-center md:mb-44 mb-16  drop-shadow-[0_0px_5px_rgba(0,200,200,0.75)]">
            #3 TOKENOMICS
          </h2>
